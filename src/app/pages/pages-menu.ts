...
export const MENU_ITEMS: NbMenuItem[] = [
  {
    ...
    children: [
      {
        title: 'Produit',
        link: '/pages/productions/produit',
      },
      {
  ...
  },
  {
    ...
    children: [
      {
        title: 'Gestion Matiere Premiere',
        link: '/pages/tables/matiere-premiere',
      },
      {
        title: 'List Matiere Premiere',
        link: '/pages/tables/list-mat-prem',
      },
      {
        title: 'Operations Complémentaires',
        link:'/pages/tables/editer-stock'
      },
      {
        title: 'Gestion Depot',
